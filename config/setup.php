...
//creating database & connect to Mysql server
try {
...
//creating users table & connecting to the previously created DATABASE
try {
...
//creating gallery table & connecting to previously created DATABASE
try {
    $db = new PDO($DB_DSN_NAME, $DB_USER, $DB_PASSWORD);
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
...
//creating like table $ connecting to previously created DATABASE
try {
    $db = new PDO($DB_DSN_NAME, $DB_USER, $DB_PASSWORD);
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
...
//creating comment table $ connecting to previously created DATABASE
try {
    $db = new PDO($DB_DSN_NAME, $DB_USER, $DB_PASSWORD);
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
