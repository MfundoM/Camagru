    ...
    <div class="cam">
        <div class="row">
            <div class="column">
                <form>
                    <label>
                        <img class="thumbnail" src="img/frameF.png" onclick="addSup(this)"></img>
                    </label>
                    <label>
                        <img class="thumbnail" src="img/water.png" onclick="addSup(this)"></img>
                    </label>
                    <label>
                        <img class="thumbnail" src="img/bloodD.png" onclick="addSup(this)"></img>
                    </label>
                    <label>
                        <img class="thumbnail" src="img/fire.png" onclick="addSup(this)"/>
                    </label>
                    <label>
                        <img class="thumbnail" src="img/windowW.png" onclick="addSup(this)"></img>
                    </label>
                    <label>
                        <img class="thumbnail" src="img/fance.png" onclick="addSup(this)"></img>
                    </label>
                </form>
                <div>
            ...
            <div class="column">
                ...
                try {
                    ...
                    //$query= $db->prepare("SELECT userid, img FROM gallery");
                    //$query->execute();
