        ...
        <div class="row">
            <div class="column">
                <div style="align-content: center">
                    <form>
                        <label>
                            <img class="thumbnail" src="img/frameF.png" onclick="addSup(this)" />
                        </label>
                        <label>
                            <img class="thumbnail" src="img/water.png" onclick="addSup(this)" />
                        </label>
                        <label>
                            <img class="thumbnail" src="img/bloodD.png" onclick="addSup(this)" />
                        </label>
                        <label>
                            <img class="thumbnail" src="img/fire.png" onclick="addSup(this)"/>
                        </label>
                        <label>
                            <img class="thumbnail" src="img/windowW.png" onclick="addSup(this)" />
                        </label>
                        <label>
                            <img class="thumbnail" src="img/fance.png" onclick="addSup(this)" />
                        </label>
                    </form>
                    <div id="frme">
